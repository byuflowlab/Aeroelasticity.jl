...
function coupling_mass_matrix_type(::Type{LiftingLine{NA,TA}}, ::Type{<:RigidBody}) where {NA,TA}
...
function get_coupling_inputs!(y, aero::LiftingLine{NA,TA}, dyn::RigidBody, u, p, t) where {NA,TA}
