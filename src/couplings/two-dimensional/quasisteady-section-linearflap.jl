...
"""
function couple_models(aero::Steady, stru::TypicalSection, flap::LinearFlap)
...
``\\rho``, and control surface deflection ``\\delta`` as additional parameters.
"""
function couple_models(aero::QuasiSteady, stru::TypicalSection, flap::LinearFlap)
    return (aero, stru, flap)
end

# --- traits --- #

number_of_additional_parameters(::Type{QuasiSteady{0}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = 3
coupling_inplaceness(::Type{QuasiSteady{0}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = OutOfPlace()
coupling_mass_matrix_type(::Type{QuasiSteady{0}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = Zeros()
coupling_state_jacobian_type(::Type{QuasiSteady{0}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = Nonlinear()

number_of_additional_parameters(::Type{QuasiSteady{1}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = 3
coupling_inplaceness(::Type{QuasiSteady{1}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = OutOfPlace()
coupling_mass_matrix_type(::Type{QuasiSteady{1}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = Zeros()
coupling_state_jacobian_type(::Type{QuasiSteady{1}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = Nonlinear()

number_of_additional_parameters(::Type{QuasiSteady{2}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = 3
coupling_inplaceness(::Type{QuasiSteady{2}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = OutOfPlace()
coupling_mass_matrix_type(::Type{QuasiSteady{2}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = Linear()
coupling_state_jacobian_type(::Type{QuasiSteady{2}}, ::Type{TypicalSection}, ::Type{LinearFlap}) = Nonlinear()
...
function get_inputs(aero::QuasiSteady{2}, stru::TypicalSection, flap::LinearFlap,
    q, p, t)
    # extract state variables
    h, θ, hdot, θdot = q
    # extract aerodynamic, structural, and aerostructural parameters
...
@recipe function f(aero::QuasiSteady, stru::TypicalSection, flap::LinearFlap,
    x, y, p, t)
