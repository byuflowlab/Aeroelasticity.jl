...
function get_input_mass_matrix(aero::QuasiSteady{2}, stru::TypicalSection,
...
function get_input_state_jacobian(aero::QuasiSteady{0}, stru::TypicalSection,
    flap::LinearFlap, q, p, t)
    # extract aerodynamic, structural, and aerostructural parameters
    a, b, a0, α0, kh, kθ, m, Sθ, Iθ, clδ, cdδ, cmδ, U, ρ, δ = p
    # return jacobian
...
function get_input_state_jacobian(aero::QuasiSteady{1}, stru::TypicalSection,
    flap::LinearFlap, q, p, t)
    # extract aerodynamic, structural, and aerostructural parameters
    a, b, a0, α0, kh, kθ, m, Sθ, Iθ, clδ, cdδ, cmδ, U, ρ, δ = p
    # return jacobian
...
function get_input_state_jacobian(aero::QuasiSteady{2}, stru::TypicalSection,
    flap::LinearFlap, q, p, t)
    # extract aerodynamic, structural, and aerostructural parameters
    a, b, a0, α0, kh, kθ, m, Sθ, Iθ, clδ, cdδ, cmδ, U, ρ, δ = p
    # return jacobian
